            ...
            <div className="app-sidebar__inner">
              <ul className="vertical-nav-menu">
                ...
                <li className="mm-active">
                  ...
                  <ul>
                    <li>
                      <Link to="/dashboards/technicalsupport">Analytics Dashboard</Link>
                      {/* <a href="index.html" className="mm-active">
                        <i className="metismenu-icon"></i>Analytics Dashboard
                      </a> */}
                    </li>
                    <li>  <Link to="/dashboards/technicalsupport">Technical Support</Link>
                    {/* <a href="index.html">
                      <i className="metismenu-icon"></i>Technical Support
                    </a> */}
                    </li>
                    <li>
                      <a href="index.html">
                        <i className="metismenu-icon"></i>Chart Card
                      </a>
                    </li>
                    <li>
                      <a href="index.html">
                        <i className="metismenu-icon"></i>Dynamic Tables
                      </a>
                    </li>
                    <li>
                      <a href="index.html">
                        <i className="metismenu-icon"></i>Task And Chatbox
                      </a>
                    </li>
                    <li>
                      <a href="index.html">
                        <i className="metismenu-icon"></i>TotalOrders
                      </a>
                    </li>
                    <li>
                      <a href="index.html">
