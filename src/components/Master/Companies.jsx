...
export default function Companies() {
  ...
  function handleSubmit(e) {
    ...
    if (id === "") {
      ...
      axios.post("http://localhost:8081/companies", data)
        .then((res) => {
      ...
      axios.put("http://localhost:8081/companies/" + id, data)
        .then((res) => {
          console.log(res.data);
          loadData();
          warningNotify();
  ...
  function handleEdit(e, _id) {
    e.preventDefault()
    setId(_id);
    axios.get("http://localhost:8081/companies/" + _id)
      .then((res) => {
        console.log(data);
        setData({
  ...
  function handleDelete(e, _id) {
    e.preventDefault()
    deleteNotify();
    axios.delete("http://localhost:8081/companies/" + _id)
      .then((res) => {
        console.log(res.data);
        loadData()
      })
        ...
        <div className="card">
          <div className="card-body">
            ...
            <div className="position-relative form-group">
              ...
              <input id="name" value={data.name} onChange={(e) => handleChange(e)} placeholder="Enter a Company" type="text" className="form-control" />
            </div>
